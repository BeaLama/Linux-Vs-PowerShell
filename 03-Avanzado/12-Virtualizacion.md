...
En este apartado se estudian los fundamentos de la virtualización, los tipos existentes, los principales hipervisores, la administración de máquinas virtuales, redes virtuales, almacenamiento, alta disponibilidad y buenas prácticas de seguridad.
...
Una empresa dispone de un servidor físico con muchos recursos.
...
VM Windows Server → Aplicación empresarial

VM Linux → Monitorización

VM Base de datos → SQL
```

El mismo hardware permite ejecutar varios servicios independientes.

---

### Buenas prácticas

- Planifica correctamente los recursos antes de crear máquinas virtuales.
- Evita sobrecargar el servidor físico.
- Monitoriza CPU, memoria y almacenamiento.
- Mantén actualizado el hipervisor.
- Documenta la infraestructura virtual.
- Define políticas de copias de seguridad.
- Separa sistemas críticos cuando sea necesario.
- Utiliza almacenamiento adecuado para cargas virtualizadas.
...
- Selecciona el tipo de virtualización adecuado según la necesidad.
- Evalúa los requisitos de rendimiento antes de implantar una solución.
- Separa correctamente redes y almacenamiento.
- Mantén actualizado el software utilizado.
- Controla el consumo de recursos.
- Documenta la arquitectura virtual.
- Aplica medidas de seguridad específicas para cada capa.
...
Una empresa utiliza un servidor físico para varias aplicaciones.
...
Gracias al hipervisor, varios servicios funcionan de forma independiente sobre el mismo hardware.

---

### Buenas prácticas

- Elige el hipervisor según las necesidades de la infraestructura.
- Utiliza hipervisores tipo 1 para servidores críticos.
- Mantén actualizado el hipervisor.
- Protege las cuentas administrativas.
- Monitoriza el consumo de recursos.
- Planifica correctamente CPU y memoria.
- Separa redes de gestión y producción.
- Realiza copias de seguridad de la configuración del hipervisor.
- Documenta todos los hosts y máquinas virtuales.
...
Una empresa necesita tres servidores:

- Controlador de dominio.
- Servidor web.
- Base de datos.

En lugar de comprar tres servidores físicos:
...
Se reducen costes y se facilita la administración.

---

### Buenas prácticas

- Asigna únicamente los recursos necesarios.
- Evita crear demasiadas máquinas virtuales en un mismo host.
- Documenta CPU, RAM y almacenamiento asignado.
- No mantengas snapshots antiguos durante largos periodos.
- Realiza backups independientes de las máquinas virtuales.
- Utiliza plantillas para despliegues repetitivos.
- Mantén actualizado el sistema operativo invitado.
- Monitoriza el rendimiento de cada VM.
- Separa máquinas críticas cuando sea necesario.
...
Un servidor físico tiene problemas de rendimiento.
...
VM SQL consume demasiada memoria
...
La solución no requiere añadir hardware inmediatamente.

---

### Buenas prácticas

- Monitoriza regularmente el consumo de recursos.
- No sobreasignes recursos sin planificación.
- Reserva recursos para sistemas críticos.
- Ajusta CPU y RAM según necesidades reales.
- Controla el crecimiento de discos virtuales.
- Evita almacenar demasiados snapshots.
- Utiliza alertas de rendimiento.
- Documenta la asignación de recursos de cada máquina virtual.
- Revisa periódicamente si las VMs siguen necesitando los recursos asignados.
...
- Separa redes de producción y administración.
- Utiliza VLAN para segmentar tráfico.
- Protege las redes de gestión del hipervisor.
- Monitoriza el tráfico virtual.
- Evita redes planas.
- Documenta switches virtuales y VLAN utilizadas.
- Configura redundancia cuando sea necesario.
- Aplica controles de seguridad también en redes virtuales.
- Revisa periódicamente la configuración de red.
...
- Utiliza almacenamiento adecuado para la carga de trabajo.
- Monitoriza espacio y rendimiento.
- No dependas únicamente de RAID.
- Mantén copias de seguridad independientes.
- Controla el crecimiento de discos virtuales.
- Evita mantener snapshots durante mucho tiempo.
- Separa almacenamiento de gestión y producción.
- Utiliza redundancia en sistemas críticos.
- Documenta la arquitectura de almacenamiento.
...
- Utiliza varios hosts para servicios críticos.
- Elimina puntos únicos de fallo.
- Configura almacenamiento redundante.
- Mantén redes separadas y redundantes.
- Prueba los mecanismos HA periódicamente.
- Documenta la arquitectura del clúster.
- Monitoriza el estado de hosts y máquinas virtuales.
- Define procedimientos de recuperación.
- No dependas únicamente de la alta disponibilidad; mantén backups.
...
- Protege las cuentas administrativas.
- Usa MFA.
- Segmenta redes virtuales.
- Cifra información sensible.
- Controla permisos.
- Monitoriza cambios.
- Realiza auditorías periódicas.
- Protege snapshots y backups.
- Elimina máquinas virtuales no utilizadas.
...
- Realiza copias periódicas de las máquinas virtuales.
- No utilices snapshots como sustituto del backup.
- Aplica la regla 3-2-1.
- Mantén copias externas.
- Protege los backups frente a ransomware.
- Prueba restauraciones regularmente.
- Documenta procedimientos de recuperación.
- Controla el espacio de almacenamiento.
- Define RPO y RTO.
- Monitoriza los trabajos de backup.
...
- Monitoriza todos los niveles de la infraestructura.
- Configura alertas importantes.
- Revisa tendencias de consumo.
- Documenta cambios realizados.
- Automatiza tareas repetitivas.
- Mantén inventario actualizado.
- Controla capacidad futura.
- Supervisa almacenamiento y red.
- Revisa logs periódicamente.
- Define responsables de administración.
...
La correcta administración de un entorno virtualizado requiere aplicar una serie de buenas prácticas que permitan mantener la infraestructura segura, estable, eficiente y preparada para crecer.

La virtualización facilita la gestión de sistemas, pero una mala configuración puede provocar problemas de rendimiento, seguridad o disponibilidad que afecten a múltiples servicios al mismo tiempo.

Las buenas prácticas deben aplicarse en todas las capas:
...
Antes de implementar un entorno virtualizado es necesario realizar una planificación adecuada.
...
Una mala planificación puede provocar falta de recursos o problemas de rendimiento.

---

### Dimensionamiento correcto de recursos

Los recursos asignados a las máquinas virtuales deben ajustarse a sus necesidades reales.
...
- Asignar demasiados recursos innecesarios.
- Crear máquinas sobredimensionadas.
- Saturar el hardware físico.

---

### Evitar la sobreasignación excesiva

Aunque la sobreasignación puede mejorar el aprovechamiento del hardware, debe utilizarse con cuidado.
...
Aunque puede funcionar, existe riesgo si todas las máquinas utilizan sus recursos simultáneamente.

---

### Mantener actualizado el hipervisor
...
### Proteger los accesos administrativos

Los accesos al entorno virtual deben estar correctamente protegidos.
...
Cuenta privilegiada independiente
```

---

### Separar redes virtuales

La segmentación de red mejora seguridad y organización.
...
### Utilizar almacenamiento adecuado

El almacenamiento debe seleccionarse según la carga de trabajo.
...
- SSD para cargas intensivas.
- SAN para entornos críticos.
- NAS para almacenamiento compartido.

---

### Monitorizar constantemente la infraestructura

La monitorización permite detectar problemas antes de que afecten a los usuarios.
...
Es importante conocer todos los elementos del entorno virtual.

Registrar:

- Nombre de máquinas virtuales.
- Sistema operativo.
- IP.
- Recursos asignados.
- Ubicación.
...
| Máquina | Sistema | CPU | RAM |
|-|-|-|-|
| DC01 | Windows Server | 4 vCPU | 16 GB |
| WEB01 | Linux | 2 vCPU | 8 GB |
...
Una infraestructura bien documentada facilita:
...
### Gestionar correctamente snapshots

Los snapshots deben utilizarse únicamente para tareas temporales.

Buenas prácticas:

- Crear snapshots antes de cambios importantes.
- Eliminarlos cuando ya no sean necesarios.
- Evitar mantenerlos durante meses.
- No utilizarlos como sistema de backup.

---

### Aplicar una estrategia de copias de seguridad

Toda infraestructura virtual debe contar con backups adecuados.

Recomendaciones:

- Seguir la regla 3-2-1.
- Mantener copias externas.
- Proteger backups frente a ransomware.
...
Los entornos virtualizados son objetivos frecuentes debido a la cantidad de sistemas que pueden verse afectados.
...
### Eliminar máquinas virtuales innecesarias

Las máquinas abandonadas aumentan:
...
No basta con tener backups; es necesario comprobar que funcionan.
...
Evita que cambios experimentales afecten a sistemas críticos.

---

### Aplicar monitorización de seguridad
...
La infraestructura debe poder ampliarse.

Planificar:

- Nuevos hosts.
- Más almacenamiento.
- Incremento de máquinas virtuales.
...
Una empresa dispone de un entorno virtualizado:
...
Infraestructura más segura y preparada ante fallos.
...
| Área | Acción |
|-|-|
| Hipervisor | Mantener actualizado |
| Seguridad | Usar MFA |
| Red | Separar VLAN |
| Almacenamiento | Monitorizar capacidad |
| Backup | Realizar pruebas |
| Administración | Documentar cambios |
| Recursos | Revisar consumo |
| Recuperación | Probar restauraciones |
